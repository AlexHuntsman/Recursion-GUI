...
public class RecursionToolTest
{
	...
	{
		assertTrue(1 == testTool.getFactorialNumber(0.0));
		assertTrue(120 == testTool.getFactorialNumber(5.0));
		assertFalse(5 == testTool.getFactorialNumber(3.0));
		assertTrue(Double.MIN_VALUE == testTool.getFactorialNumber(-5.0));
	}
